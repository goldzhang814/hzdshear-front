...
import ShoppablePublish from '@/views/ShoppablePublish.vue'
import Login from '@/views/Login.vue'

const routes = [
  // 公开页面
  {path: '/', component: Landing, meta: {public: true, title: 'Shear - TikTok Business Management'}},
  ...
  { path: '/shoppable',          component: ShoppablePublish,  meta: { title: 'Shoppable Video',     nav: 'shoppable'  } },
]
